...
# Modify source code for MSVC to insert library search records (so VCPKG can properly handle binary copying). NB: Only works with MSVC
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    set(libEGLDynamicLibraries libGLESv2)
    if(USE_VULKAN_BACKEND)
        list(APPEND libEGLDynamicLibraries vulkan-1)
    endif()
    insert_msvc_library_loading_records("${SOURCE_PATH}/src/libEGL/libEGL_autogen.cpp" "${libEGLDynamicLibraries}")
endif()
